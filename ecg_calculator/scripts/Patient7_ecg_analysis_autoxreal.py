...
RAW_OUTPUT_DIR = Path("./P7_results/autoxmanual/ecg_cru")
ANALYSIS_FILE = Path("./P7_results/autoxmanual/analise_comparativa.txt")

LEADS_AUTOMATICO = np.array(
    [
    [ 85055.035627,  147149.644541, -1348.074495],  # V1
    [ 98262.759119,  120354.083199,  23906.266890],  # V2
    [ 99079.949304,  98574.523857,  50490.376844],  # V3
    [ 95106.453055,  76119.711315,  74590.958278],  # V4
    [ 127952.780573, -10119.668742,  83531.844507],  # V5
    [ 131426.850776, -79269.619068,  34782.590180],  # V6
    ],
    dtype=np.float64,
)
...
LEADS_REAL = np.array(
    [
    [ 62562.346705,  137493.927913,  19797.891464],  # V1
    [ 90712.789497,  103596.054218,  49391.818706],  # V2
    [ 95350.704178,  75891.125292,  73460.245339],  # V3
    [ 92740.469118,  52741.860343,  88388.450365],  # V4
    [ 137929.211685, -61281.754998,  69799.956886],  # V5
    [ 135350.939741, -88410.376564,  45146.541186],  # V6
    ],
    dtype=np.float64,
)
